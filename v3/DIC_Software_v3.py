...
class DIC_app(ttk.Frame):
    ...
    def start_up_screen(self):
        ...
        self.GoPro_button.place(relx= .25, rely= .33, anchor= tk.CENTER)
        ...
        self.Mobile_button.place(relx= .5, rely= .33, anchor= tk.CENTER)
        ...
        self.Existing_button.place(relx= .75, rely= .33, anchor= tk.CENTER)
        ...
        self.Calibration_GP_button.place(relx= .33, rely= .66, anchor= tk.CENTER)

        self.Calibration_M_button = ttk.Button(self.canvas, text= "Create new cellphone\ncamera calibration file", style='my.TButton',command= lambda : self.Calibration_M_App_start())
        self.Calibration_M_button.place(relx= .66, rely= .66, anchor= tk.CENTER)
    ...
    def GoPro_App_start(self):
        ...
        connection_label.place(relx=0.5,rely=0.5,anchor=tk.N)
    ...
    def connect_to_mobile_camera(self):
        ...
        try:
            ...
            if self.ref_img is None and self.mode=='Mobile':
    ...
    def input_info_screen(self):
        ...
        if self.mode == 'Mobile' or self.mode == "GoPro":
    ...
    def remove_image_distortion_func(self,img_path):
        ...
        elif self.mode=='GoPro' or self.mode=='Mobile':
        ...
        if self.mode=='Existing':
            if self.analysis_ran == True:
                if self.remove_image_distortion == True:
                    ...
                    self.image_base = Image.open(self.photo_path+'\\'+self.start_photo)
            # else:
            #     self.track_area_coords_initial = self.track_areas_co_ords[-1]
        self.img_tx = 0
        self.img_ty = 0
    ...
    def run_analysis(self):
        ...
        if self.mode=='Existing':
            ...
            if self.download_photos==True and self.mode=='Mobile':
