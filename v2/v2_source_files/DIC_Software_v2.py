...
class DIC_app(ttk.Frame):
    ...
    def __init__(self, master):
        ...
        self.output_path = r'C:\Users\S1879083\OneDrive - University of Edinburgh\Edi_Python\Video_tracking\Video_tracking_app\v2'
    ...
    def run_analysis(self):
        ...
        headers = ['Timestamp','Load cell output [kN]']

        output_data = [list(self.time_data),list(self.load_data)]
    ...
    def start_up_screen(self):
        ...
        if self.existing_data==True:
            ...
            tk.Label(self.info_canvas,text='Output filename').place(relx= .05, rely= .4, anchor= tk.W)
            tk.Entry(self.info_canvas, width= 150,textvariable=self.output_file).place(relx= .05, rely= .45, anchor= tk.W)
    ...
    def take_photo(self):
        photo_url = self.gopro.take_photo(0)
        self.new_img= Image.open(urllib.request.urlopen(photo_url))
